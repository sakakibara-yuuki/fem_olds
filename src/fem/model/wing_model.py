...
class WingModel:
    ...
    def rotate_wing(self):
        ...
        tc = gmsh.model.getEntitiesInBoundingBox(
            -eps, -eps, z - eps, bb[3] + eps, 1, z + eps, dim=1
        )
        ...
        gmsh.model.occ.rotate(
            gmsh.model.occ.getEntities(2), 0.25, 0, 0, 0, 0, 1, incidence
        )
    ...
    def set_boundary(self):
        ...
        extbl = gmsh.model.geo.extrudeBoundaryLayer(
            gmsh.model.getEntities(2), [1] * N, d, True
        )
